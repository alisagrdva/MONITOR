class InstaPostsController < ApplicationController
  before_action :set_insta_post, only: [:show, :edit, :update, :destroy]

  # GET /insta_posts
  # GET /insta_posts.json
  def index
    @insta_posts = InstaPost.all
  end

  # GET /insta_posts/1
  # GET /insta_posts/1.json
  def show
  end
  ...
  # PATCH/PUT /insta_posts/1
  # PATCH/PUT /insta_posts/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /insta_posts/1
  # DELETE /insta_posts/1.json
  def destroy
    @insta_post.destroy
    respond_to do |format|
  ...
  private
    ...
    def insta_post_params
      params.require(:insta_post).permit(:moniitor_id, :insta_account_id, :insta_tag_id)
    end
end
