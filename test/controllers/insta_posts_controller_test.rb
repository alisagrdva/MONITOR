...
class InstaPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insta_post" do
    assert_difference('InstaPost.count') do
      post insta_posts_url, params: { insta_post: { insta_account_id: @insta_post.insta_account_id, insta_tag_id: @insta_post.insta_tag_id, moniitor_id: @insta_post.moniitor_id } }
    end
  ...
  test "should update insta_post" do
    patch insta_post_url(@insta_post), params: { insta_post: { insta_account_id: @insta_post.insta_account_id, insta_tag_id: @insta_post.insta_tag_id, moniitor_id: @insta_post.moniitor_id } }
